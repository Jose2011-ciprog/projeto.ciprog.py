...
texto_conselhos = ["A cultura da paz começa com pequenas atitudes diárias, como respeitar as diferenças e praticar a empatia.\nOuvir o próximo com atenção e evitar julgamentos ajuda a construir relações mais harmoniosas.\nResolver conflitos por meio do diálogo é uma forma inteligente e madura de promover a convivência saudável.\nTambém é importante incentivar a solidariedade, a gentileza e o apoio entre as pessoas no ambiente escolar e familiar.\nQuando cada um faz sua parte com responsabilidade e respeito, a paz se torna possível em toda a sociedade\n\n"]

conselho = ""
for item in texto_conselhos:
    print(item)
    print("\nCom base no texto conselho responda\n\n")
    print("Qual atitude contribui para a construção de uma cultura da paz?\n\nA) Incentivar discussões e conflitos entre as pessoas.\nB) Resolver problemas com violência e agressividade.\nC) Praticar o respeito, o diálogo e a empatia no dia a dia.\nD) Ignorar os sentimentos e opiniões dos outros")
    input("De acordo com o texto qual é a alternativa correta?")
    
    if conselho == "C":
        print("Você tem uma boa interpretação")
        ponto += 15
    elif conselho == "A":
        print("Bem meio termo, mas esta bom")
        ponto += 5
    else:
        print("Você deve melhorar sua interpretação e aprender melhor o conseito de Cultura da Paz")
        ponto -= 9
